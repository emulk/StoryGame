									...
									avanti.setOnClickListener(new View.OnClickListener() {
										...
										public void onClick(View v) {
											...
											textview.setText("L'uomo inizia a raccontare la storia della Pietra del potere. La pietra era stata" +
													...
													" Durante una batagli preso il fiume Ridhan il re fu ucciso, e la lancia dorata gli cade di mano inabissandosi nelle profondità delle acque del fiume e la pietra'andro perduita.");
							...
							public void onClick(View v) {
								...
								avanti.setOnClickListener(new View.OnClickListener() {
									...
									public void onClick(View v) {
										// TODO Auto-generated method stub
										textview=(TextView)findViewById(R.id.story1);
										textview.setText("Continuo a inoltrarmi nel campo fino ad arrivare davanti alla \"Taverna del rospo\", e la taverna più famosa del villaggio proprio perchè e qui che servono la birra più buona, " +
										...
										avanti.setOnClickListener(new View.OnClickListener() {
											...
											public void onClick(View v) {
												...
												textview.setText("Arrivo davanti al balcone, e il proprietario della taverna, un uomo basso e cicciotello mi porgie un bocale" +
														" e subito dopo lo riempie di bira. \"Se lo goda con calma signore\" dice \"questa e la miglior birra che potrà trovare in tutto il paese\", " +
