...
public class Guerra extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		textview.setText(" Mi unisco all'esercito di Ardus, il comandante ci ordina di mantenere la posizione. " +
				...
				" ma grazie alla nostra superiorità  numerica li soprafiamo facilmente. Poiche non c'era tempo di fare prigionieri," +
		 ...
		 avanti.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				textview.setText("I due gruppi si formano velocemente, ma ciò vorrebbe dire 10 cavalieri in meno per proteggere la nostra città ." +
						...
						" \"Entriamo in città  e iniziamo i preparativi per la difesa e il contro attacco, salveremo il nostro paese\".  " );
				...
				avanti.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							...
							textview.setText("Eseguo gli ordini del capitano ed entriamo dentro le mura, l'immensa porta vine chiusa alle " +
									"nostre spalle, da quel momento nessuno poteva piÃ¹ entrare o uscire dalla città . " +
									...
									avanti.setOnClickListener(new View.OnClickListener() {
										...
										public void onClick(View v) {
											...
											textview.setText("Scelgo i cinque guerrieri vicino a me, iniziamo a scendere nella grotta, arrivati " +
													...
													", trappole ovunque e come se non bastase gli arcieri stavano preparando le freccie infuocate, volevano " +
												...
												public void onClick(View v) {
													...
													avanti.setOnClickListener(new View.OnClickListener() {
														...
														public void onClick(View v) {
															...
															textview.setBackgroundResource(R.drawable.death);
															textview=(TextView)findViewById(R.id.guerrastory);
															textview.setText("Ci prepariamo per affrontare i nemici intanto che si avvicinavano sempre di piÃ¹, dietro di loro c'e n'erano" +
									...
									second.setOnClickListener(new View.OnClickListener() {
										...
										public void onClick(View v) {
											...
											textview.setText("Aggire in gruppo sarebbe stato troppo pericoloso, avviso il capitano che sarei andato da solo e" +
													...
													" qualcuno aveva giÃ¹ fatto il bucco nel muro, il bucco era piccolo, ma bastava per passarci attraverso " +
													" e uscire in campo aperto. Purtroppo non potevo avere un cavalo, era impossibile farlo scendere nella grotta," +
													" ed era ancora piÃ¹ difficile farlo passare attraverso quel'piccolo bucco.");
											avanti.setVisibility(View.INVISIBLE);
											...
											second.setOnClickListener(new View.OnClickListener() {
												...
												public void onClick(View v) {
													// TODO Auto-generated method stub
													textview=(TextView)findViewById(R.id.guerrastory);
													textview.setText("Esco dalla grotta, camino per un po in campo aperto per avvicinarmi sempre di piÃ¹ alle loro spalle" +
															", erano ancora piÃ¹ orrendi da vicino, sembravano piÃ¹ bestie che uomini." +
													...
													second.setOnClickListener(new View.OnClickListener() {
														...
														public void onClick(View v) {
															...
															textview.setText("Giro le spalle e inizio a rientrare, faccio pocchi passi quando inizio a sentire degli abbai," +
																	...
																	"correre il piÃ¹ che potevo, non penso a niente altro, solo a correre, faccio una decina di passi, " +
																	"mi avvicino alle mura per rientrare, quando il mio corpo si blocca, si blocca di colpo, non rispondeva" +
																	" piÃ¹ ai miei comandi, abbaso lo sguardo e vedo un fiume di sangue uscire dal mio petto, maleddeti, " +
							...
							second.setOnClickListener(new View.OnClickListener() {
								...
								public void onClick(View v) {
									...
									textview = (TextView) findViewById(R.id.guerrastory);
									textview.setText("Le grotte erano chiuse da piÃ¹ di mille anni, l'aria sarebbe stata scarsa e pesante, non era addatto a delle persone " +
								...
								avanti.setOnClickListener(new View.OnClickListener() {
									...
									public void onClick(View v) {
										...
										textview = (TextView)findViewById(R.id.guerrastory);
										textview.setBackgroundResource(R.drawable.death);
										textview.setText("Alle prime luci dell'alba si sente un forte boato, ci svegliamo tutti di botto. " +
								...
								second.setOnClickListener(new View.OnClickListener() {
									...
									public void onClick(View v) {
										...
										textview.setText("Vedevo negli occhi dei miei compagni la paura e contemporamente la speranza ." +
												...
												"cittÃ  vicina di Nedres , entrero a fare parte del loro esercitto, e salveremo la mia citta, in " +
												...
												" Volevo raggiungere gli altri cavalieri che erano partiti prima di me, ma ormai era troppo tardi, mi lancio a tutta velocitÃ  per " +
												"allontanarmi il piÃ¹ possibile dal mio villaggio, mi indentro sempre di piÃ¹ nel bosco, fino ad arrivare alla fonte in mezzo al bosco," +
												" mi fermo per abbeverare il mio cavallo, ma alle mie spalle spuntano tre cavalieri. No, non potevano esser dei nemici, " +
												"era passato cosi poco tempo, non avrebbero fatto in tempo ad essere giÃ¹ qui. Si avvicinano, scendono da cavallo e..., senza neanche" +
												" che mi accorga di ciÃ  che stava succedendo mi ritrovo per tera, senza vita. Ora capisco,  il comandante aveva mandato tre cavalieri " +
				...
				second.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						textview.setText("Vedevo negli occhi dei miei compagni la paura e contemporamente la speranza ." +
								" Ma se fossi scapato avrei avuto piu' possibilita' di sopravivenza. Potevo rifugiarmi nella " +
								"citta'  vicina di Nedres , entrero a fare parte del loro esercitto, e salveremo la mia citta, in " +
								"questo modo sembrero un eroe e avro la vita salva. E un piano geniale. Mentre gli altri iniziano a rientrare in citta io mi volto dall'altra parte e sparisco nel bosco." +
								" Volevo raggiungere gli altri cavalieri che erano partiti prima di me, ma ormai era troppo tardi, mi lancio a tutta velocitÃ  per " +
								"allontanarmi il piÃ¹ possibile dal mio villaggio, mi indentro sempre di piÃ¹ nel bosco, fino ad arrivare alla fonte in mezzo al bosco," +
								" mi fermo per abbeverare il mio cavallo, ma alle mie spalle spuntano tre cavalieri. No, non potevano esser dei nemici, " +
			...
			second.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					textview.setText("Non me la sentivo di rimanere nel villaggio, sarebbe stato inutile, avrei dovuto aspettare gli rinforzi senza poter fare " +
							"nulla, impotente, non e questo ciÃ² che voglio, io voglio salvare il mio villaggio, la terra dove sono nato," +
							" i miei amici, la mia casa, tutto ciÃ² che ho si trova qui non posso permettermi di perderla, la cosa migliore che posso fare e avvisare gli alleati e schiacciare l'esercito oscuro delle tenebre. ");
					...
					avanti.setOnClickListener(new View.OnClickListener() {
						...
						public void onClick(View v) {
							// TODO Auto-generated method stub
							textview=(TextView)findViewById(R.id.guerrastory);
							textview.setText("Il villaggio di Nedres era uno dei pochi villaggi alleati che avevamo. Si trovava a sud-est del campo d'adestramento , a circa 1 giorno e mezzo di cammino a cavallo.");
