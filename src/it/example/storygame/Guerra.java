									...
									second.setOnClickListener(new View.OnClickListener() {
										...
										public void onClick(View v) {
											...
											textview.setText("Aggire in gruppo sarebbe stato troppo pericoloso, avviso il capitano che sarei andato da solo e" +
													...
													" qualcuno aveva giù fatto il bucco nel muro, il bucco era piccolo, ma bastava per passarci attraverso " +
								...
								second.setOnClickListener(new View.OnClickListener() {
									...
									public void onClick(View v) {
										...
										textview.setText("Vedevo negli occhi dei miei compagni la paura e contemporamente la speranza ." +
												...
												"era passato cosi poco tempo, non avrebbero fatto in tempo ad essere giù qui. Si avvicinano, scendono da cavallo e..., senza neanche" +
												" che mi accorga di cià che stava succedendo mi ritrovo per tera, senza vita. Ora capisco,  il comandante aveva mandato tre cavalieri " +
